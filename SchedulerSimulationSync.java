...
class SharedResources {
    ...
    // Task 2: ReentrantLock for protecting execution log
    ...
    public static void incrementCompletedProcess() {
        // TODO: Protect this critical section with a lock
// Task 1: Acquire lock before modifying shared counter
        counterLock.lock();
        try {
...
// Task 2: Acquire lock before modifying shared ArrayList
        logLock.lock();
        try {
...
class Process implements Runnable {
    ...
    @Override
    public void run() {        // TODO #3: Acquire CPU semaphore before executing
...
public class SchedulerSimulationSync {
    public static void main(String[] args) {
        ...
        int studentID = 445052020;  // ← CHANGE THIS TO YOUR ACTUAL STUDENT ID
